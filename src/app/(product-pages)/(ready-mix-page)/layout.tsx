...
import ReadyMixBanner from "../../../../public/banners/ReadyMix.png"
    ...
    return (
        <main className={`bg-white py-10`}>
            <div className="text-center flex justify-center md:py-10 py-5 container">
                <Image src={ReadyMixBanner} alt="ReadyMixBanner" placeholder="blur" className="object-cover object-center"/>
            </div>
