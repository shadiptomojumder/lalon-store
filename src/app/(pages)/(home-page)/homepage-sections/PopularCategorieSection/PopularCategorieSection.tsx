...
<div className="left-ribbon flex flex-col justify-start items-start absolute top-0 left-2.5 z-50 max-w-[50%] text-left"><div className="bg-main text-white text-[11px] inline-block leading-none font-medium min-w-30 text-center p-[5px] pb-0 mb-2.5 relative after:h-[10px] after:w-full after:absolute after:top-[calc(100%-1px)] after:left-0 after:bg-[url(/ribbon-icon-bg.png)] after:bg-[length:10px_10px] after:bg-[bottom_center] after:bg-repeat-x">৳13.40<br/>OFF</div></div>
